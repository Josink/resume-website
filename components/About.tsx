    ...
    return (
        <section id = "about" className = "about">
            <div className = "personal-info">
                <h2 className = "personal-info-intro">
                ...
                <div className = "personal-info-text">
                    ...
                    <h3>When I&#39;m not coding, you&#39;ll probably find me mentoring robotics students, reading, baking,
            ...
            <div className = "edetails">
                    ...
                    {about.map((about, i) => (
                        <div key={i} className="edu">
                            <div className="details">
                                <h2 className="school">{about.school}</h2>
                                <h5 className="time">{about.time}</h5>
                            </div>
                            <h4 className="description">{about.description}</h4>
                        </div>
                    ))}
                </div>
                ...
                <div className="extracurriculars">
                    ...
                    {ext.map((ext, i) => (
                        <div key={i} className="edu">
                            <div className="details">
                                <h2 className="location">{ext.location}</h2>
                                <h5 className="time">{ext.time}</h5>
                            </div>
                            <h4 className="description">{ext.description}</h4>
                        </div>
                    ))}
                </div>
            </div>
