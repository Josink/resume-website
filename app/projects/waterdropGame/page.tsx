            ...
            <div className = "project-body">
                ...
                <div className="projects-description">
                    <ul className="project-bullets">
                        <li>Developed a cross-platform 2D slider game in Java using the libGDX game development
                            framework and
                            OpenGL.
                        </li>
                        <li>Implemented keyboard and touchscreen input handling, allowing players to interact with the
                            game
                            across desktop and mobile platforms.
                        </li>
                        <li>Structured the project using libGDX&#39;s modular architecture and Gradle build system to
                            support
                            desktop, Android, and web platforms.
                        </li>
                    </ul>
                </div>
            </div>
