            ...
            <div className = "project-body">
                ...
                <div className="projects-description">
                    <ul className="project-bullets">
                        <li>Developed a Next.js/React web application that generates random quotes from Richard
                            Siken&#39;s Crush
                        ...
                        <li>Implemented interactive features allowing users to generate new quotes, copy quotes directly
                            to
