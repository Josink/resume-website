            ...
            <div className = "project-body">
                ...
                <div className="projects-description">
                    <ul className="project-bullets">
                        <li>Developed a full-stack web application for exploring and executing common sorting and
                            searching
                        ...
                        <li>Built dynamic server-rendered pages using EJS and integrated frontend forms with backend
                            routes
                            to process algorithm execution requests and persist user activity.
                        </li>
                        <li>Designed an interactive interface for selecting algorithms and configuring test inputs,
                            providing
